...
export function DataTable<TData>({
  ...
  const handleFilterChange = (key: string, value: string) => {
    ...
    const payloadForParent: Record<string, string> = { ...updated }
    if (payloadForParent.frequently) {
      payloadForParent.recurringStatus = payloadForParent.frequently
      delete payloadForParent.frequently
    }

    onFilterChange?.(payloadForParent)
  }
