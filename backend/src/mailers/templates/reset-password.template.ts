export const getResetPasswordTemplate = (
  ...
  const title = 'Finsight Password Reset'
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
              ...
              <tr>
                <td style="background-color: #00bc7d; padding: 20px 30px; color: #ffffff; text-align: center;">
                  <h2 style="margin: 0; font-size: 24px; text-transform: capitalize">Reset Your Password</h2>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 20px 30px;">
                  ...
                  <p style="margin: 0 0 20px; font-size: 16px;">We received a request to reset the password for your Finsight account. Please use the verification code below to proceed:</p>
                  ...
                  <p style="margin: 0; font-size: 13px; color: #888; line-height: 1.5;">If you did not request a password reset, please ignore this email or contact our support team immediately, as your account may be compromised.</p>
                </td>
              </tr>
