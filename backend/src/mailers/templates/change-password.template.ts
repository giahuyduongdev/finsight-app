export const getChangePasswordTemplate = (
  username: string,
  otpCode: string,
  expiresInMinutes: number = 5
) => {
  const currentYear = new Date().getFullYear()
  const title = 'Finsight Password Change'
            ...
            <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
              ...
              <tr>
                <td style="background-color: #00bc7d; padding: 20px 30px; color: #ffffff; text-align: center;">
                  <h2 style="margin: 0; font-size: 24px; text-transform: capitalize">Change Your Password</h2>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 20px 30px;">
                  ...
                  <p style="margin: 0 0 20px; font-size: 16px;">You requested to change the password for your Finsight account. Please use the verification code below to confirm this change:</p>
                  ...
                  <p style="margin: 0; font-size: 13px; color: #888; line-height: 1.5;">If you did not request to change your password, please ignore this email or contact our support team immediately.</p>
                </td>
              </tr>
