...
// ─── AnalyticsService Class (New - DI-based) ─────────────────────────────────

/**
 * AnalyticsService Class
 * Handles analytics-related business logic with dependency injection
 */
export class AnalyticsService {
  ...
  async getAnalytics(
    ...
    const currentResults = await TransactionModel.aggregate(
